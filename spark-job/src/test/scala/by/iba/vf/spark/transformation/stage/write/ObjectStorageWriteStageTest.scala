...
class ObjectStorageWriteStageTest extends AnyFunSpec with PrivateMethodTester with MockitoSugar {
  it("COSWriteStage") {
    ...
    val stage = new COSWriteStage("id1", ObjectStorageWriteCOSStageBuilder, cosConfig, Map(), "cos_storage")
  ...
  it("S3WriteStage") {
    ...
    val stage = new COSWriteStage("id1", ObjectStorageWriteS3StageBuilder, cosConfig, optionsMap, "s3_storage")
